...
#         ax.set_ylim([-10, 35]) 
#         plt.show(block=False)
#         plt.savefig("/home/yuzuki/Pictures/ochi_test_all" + "/" + str(file_number) + ".png") 
#         plt.pause(1)
#         plt.close()
...
# def draw_training_pos_ochi():
#     index = 0
#     file_number = 1
#     while index < 100:
#         image = Image.open(('/home/yuzuki/catkin_ws/src/nav_cloning')+'/maps/cit_3_map2.pgm').convert("L")
#         arr = np.asarray(image)
#         fig = plt.figure()
#         ax = fig.add_subplot(111)
#         ax.imshow(arr, cmap='gray', extent=[-20.5,17.5,-9,29])
#         vel = 0.2
#         arrow_dict = dict(arrowstyle = "->", color = "black")
#         count = 0
